...
#     print MF
model_enwik.load_CW('enwik-200/PS10iter_fromSVD_dim200_step5e-05_factors', 3)
x = datasets_corr(model_enwik, "datasets", "enwik-200/PS10iter_fromSVD_dim200_step5e-05_factors",MAX_ITER,plot_corrs=False)
for i in x:
    print i
    print x[i]
